            ...
            <div className={style.wrapperBlocks}>
                <div className={style.firstBlock + " " + style.first}>
                    ...
                    <div className={style.wrapperInfo}>
                        <p>Arrival in Auckland is the main gateway to New Zealand, a city that is famous for its graceful lines of the Harbor Bridge, the sparkling waters of Waitemata Harbor and the Hauraki Gulf.</p>
                    </div>
                </div>
